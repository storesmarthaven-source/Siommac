...
export const widgets: WidgetDef[] = [
  previewDefinition({ id: 'hr.employeeMaster.blockedActions', title: 'Blocked employee actions', description: 'Employee record actions currently blocked or approaching their due dates.', icon: 'fa-circle-exclamation', category: 'Actions & workload', recommended: true, defaultSize: 'standard', previewAspect: 1.08, sizeConstraints: { defaultColumns: 10, defaultRows: 5, minColumns: 7, minRows: 5, minWidth: 350, minHeight: 390, resizeStrategy: 'content-measured' }, tags: ['blocked actions', 'deadlines', 'selection a'], previewVariant: 'task-board', motion: { kind: 'sequence', durationMs: 640, reducedMotion: 'static' }, component: BlockedEmployeeActions, allowedSizes: DESIGN_SIZES }),
  previewDefinition({ id: 'hr.employeeMaster.readinessGoal', title: 'Team readiness goal', description: 'Shared progress toward complete employee records.', icon: 'fa-bullseye', category: 'Health & readiness', recommended: true, defaultSize: 'large', previewAspect: 2.1, sizeConstraints: { defaultColumns: 16, defaultRows: 5, minColumns: 8, minRows: 5, minWidth: 390, minHeight: 330, resizeStrategy: 'content-measured' }, tags: ['team readiness', 'goal', 'selection d'], previewVariant: 'people', motion: { kind: 'progress', durationMs: 760, reducedMotion: 'static' }, component: TeamReadinessGoal, allowedSizes: DESIGN_SIZES }),
  ...
  previewDefinition({ id: 'hr.employeeMaster.recordHealth', title: 'Employee record health', description: 'Completeness across identity, employment, documents, and access.', icon: 'fa-shield-heart', category: 'Health & readiness', recommended: true, defaultSize: 'standard', previewAspect: 1.08, sizeConstraints: { defaultColumns: 8, defaultRows: 4, minColumns: 5, minRows: 3, minWidth: 250, minHeight: 270, resizeStrategy: 'content-measured' }, tags: ['record health', 'completeness', 'selection f'], previewVariant: 'donut', motion: { kind: 'sequence', durationMs: 780, reducedMotion: 'static' }, component: RecordHealth, allowedSizes: HEALTH_SIZES }),
