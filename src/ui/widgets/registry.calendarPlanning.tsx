...
export const widgets: WidgetDef[] = [
  ...
  liveDefinition({ id: 'enterprise.calendar.taskPlanner', title: 'Task planner', description: 'Calendar tasks and authorised module work with personal-task creation.', icon: 'fa-list-check', category: 'Calendar & deadlines', defaultSize: 'standard', recommended: true, allowedSizes: TASK_SIZES, sizeConstraints: { defaultColumns: 8, defaultRows: 4, minColumns: 6, minRows: 4, minWidth: 300, minHeight: 340, resizeStrategy: 'content-measured' }, previewAspect: 1.05, actions: { createPersonalTask: 'calendar.task.manage_own', completeTask: 'calendar.task.manage_own' }, render: TaskPlannerWidget, renderPreview: TaskPlannerPreview }),
];
