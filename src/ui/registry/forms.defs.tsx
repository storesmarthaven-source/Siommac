...
export const themeModeSwitchDef: ComponentDef = {
  ...
  style: [
    { label: 'Track', controls: [
      ...
      { name: '--ui-theme-switch-light-knob', label: 'Light knob', kind: 'color' },
      { name: '--ui-theme-switch-dark-knob', label: 'Dark knob', kind: 'color' },
    ] },
    { label: 'Icons', controls: [
      { name: '--ui-theme-switch-icon', label: 'Sun and moon', kind: 'color' },
    ] },
  ],
  states: ['default', 'selected', 'focus', 'disabled', 'loading'],
  compare: ['default', 'selected', 'focus', 'disabled'],
