  ...
  return (
    <div class="sds-button-browser">
      ...
      <section class="sds-button-browser__section" aria-labelledby={`${family.id}-components-title`}>
        <header><div><h3 id={`${family.id}-components-title`}>{family.name} components</h3><p>Choose the behavior you need, then edit its live canonical preview.</p></div><span>{members.length} components</span></header>
