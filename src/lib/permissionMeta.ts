...
export const PERMISSION_META: Record<PermissionKey, PermissionMeta> = {
  ...
  'hr.employees.readiness.view': { module: 'HR', group: 'Employee Master', label: 'View Employee Readiness', description: 'View readiness controls and their state for an employee.', risk: 'medium' },
  'hr.employees.readiness.follow_up': { module: 'HR', group: 'Employee Master', label: 'Follow Up Readiness Work', description: 'Coordinate, remind and reassign readiness work items without deciding them.', risk: 'medium' },
  'hr.employees.readiness.review': { module: 'HR', group: 'Employee Master', label: 'Review Readiness Evidence', description: 'Approve or return submitted readiness evidence.', risk: 'high' },
  'hr.employees.access_assignments.view': { module: 'HR', group: 'Employee Master', label: 'View Access Assignments', description: 'View an employee access assignments and their recorded scope.', risk: 'medium' },
  'hr.employees.access_assignments.manage': { module: 'HR', group: 'Employee Master', label: 'Manage Access Assignments', description: 'Grant, scope or revoke an employee access assignment.', risk: 'high' },
  ...
  'ui.widgets.governance.view': { module: 'System', group: 'Widgets', label: 'View Widget Governance', description: 'View widget enablement and placement policy.', risk: 'low' },
  'ui.widgets.governance.manage': { module: 'System', group: 'Widgets', label: 'Manage Widget Governance', description: 'Manage widget enablement and placement policy.', risk: 'medium' },
  'ui.widgets.sources.view': { module: 'System', group: 'Widgets', label: 'View Widget Data Sources', description: 'View approved authenticated widget data sources.', risk: 'low' },
  'ui.widgets.sources.manage': { module: 'System', group: 'Widgets', label: 'Manage Widget Data Sources', description: 'Manage approved authenticated widget data-source registrations.', risk: 'high' },
