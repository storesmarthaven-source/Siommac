import type { Orientation, PageSize } from '@payslip/types';
import { PAGE_SIZE_LABELS } from '@payslip/constants/pageSizes';
import { useDesigner } from '@payslip/state/DesignerContext';
import { ColorField } from '@payslip/components/color/ColorField';
import { Row, Segmented, Select } from '@payslip/components/ui/controls';
