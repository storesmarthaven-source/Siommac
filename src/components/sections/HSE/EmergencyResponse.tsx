  ...
  return (
    <div class="ppe-tab-content">
      <div class="hse-spark-row">
        ...
        <div class="hse-spark"><div class="hse-spark-header"><span class="hse-spark-label">Avg Score</span><i class="fas fa-gauge-high" /></div><div class="hse-spark-val" style={{ color: avgScore >= 85 ? '#22c55e' : '#f59e0b' }}>{Math.round(avgScore)}%</div><div class="hse-spark-sub">Drill performance rating</div></div>
