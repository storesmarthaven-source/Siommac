...
import { Badge, PageHeader, Modal, Field, FormGrid, SearchField, Select, TextInput, TextareaInput, Button } from '@ui';
  ...
  return (
    <div class="hr-onboarding-packages">
      ...
      <div style={{ display: 'flex', gap: 10, margin: '14px 0' }}>
        ...
        <Select style={{ width: 160 }} value={status} onChange={value => setStatus(value as StatusFilter)}
          options={STATUS_FILTERS.map(value => ({ value, label: value === 'all' ? 'All statuses' : value.charAt(0).toUpperCase() + value.slice(1) }))} aria-label="Filter onboarding packages by status" />
      </div>
