...
export function defaultEmployeeLayout(): BoardLayout {
  return {
    ...
    zones: {
      main: [
        defInst('hr.employeeMaster.activeWorkforce', 0, 0, 6, 2, 'compact'),
        defInst('hr.employeeMaster.recordReadiness', 6, 0, 6, 2, 'compact'),
        defInst('hr.employeeMaster.hrWorkQueue', 12, 0, 6, 2, 'compact'),
        defInst('hr.employeeMaster.exceptions', 18, 0, 6, 2, 'compact'),
        defInst('hr.employeeMaster.workforceTrend', 0, 2, 12, 4, 'wide'),
        defInst('hr.employeeMaster.workforceDistribution', 12, 2, 12, 4, 'wide'),
        defInst('hr.employeeMaster.lifecycleMovement', 0, 6, 12, 5, 'wide'),
        defInst('enterprise.calendar.upcomingDeadlines', 12, 6, 6, 5, 'standard'),
        defInst('hr.employeeMaster.masterDataWorkload', 18, 6, 6, 5, 'standard'),
        defInst('hr.employees.register', 0, 11, EMPLOYEE_BOARD_COLUMNS, 9, 'hero'),
      ],
    },
  };
}
