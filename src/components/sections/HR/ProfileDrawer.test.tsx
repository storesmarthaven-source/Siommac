...
const employee = {
  ...
  readiness: { percent: 67, assignmentComplete: true, payrollStatus: 'blocked' as const, trainingStatus: 'due_soon' as const, blockers: ['payroll', 'training'] as Array<'payroll' | 'training'> },
};
