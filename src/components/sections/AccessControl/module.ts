...
const ITEMS: ModuleNavItem[] = [
  { id: 's-ac-overview',   label: 'Overview',        icon: 'fa-table-columns',   sub: 'Roles, users and module-by-role coverage at a glance', roles: ['superadmin'] },
  { id: 's-ac-users',      label: 'User Access',     icon: 'fa-user-lock',       sub: 'Per-user capability overrides (role default / allow / deny)', roles: ['superadmin'] },
  { id: 's-ac-roles',      label: 'Roles',           icon: 'fa-user-shield',     sub: 'Create and manage roles and their default permission sets', roles: ['superadmin'] },
  { id: 's-ac-coverage',   label: 'Module Coverage', icon: 'fa-layer-group',     sub: 'Capability breakdown by module group × role', roles: ['superadmin'] },
  { id: 's-ac-approvals',  label: 'Approvals',       icon: 'fa-clipboard-check', sub: 'Maker-checker queue for critical permission grants', permission: 'communications.compliance_approve' },
  { id: 's-ac-audit',      label: 'Audit Log',       icon: 'fa-clipboard-list',  sub: 'Append-only record of every privileged action', roles: ['superadmin'] },
  { id: 's-ac-sessions',   label: 'Sessions',        icon: 'fa-user-clock',      sub: 'Active sessions with device context + remote revoke', roles: ['superadmin'] },
  { id: 's-ac-payslip-designer', label: 'Payslip Designer', icon: 'fa-file-invoice', sub: 'Design and manage the payslip layout templates used across payroll', roles: ['superadmin'] },
];
