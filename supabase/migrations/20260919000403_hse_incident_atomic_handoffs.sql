-- ============================================================================
-- HSE incident creation: incident + people + workflow + audit/event + handoff
-- intent commit as one transaction. Supports both bound and no-binding cases.
-- ============================================================================
...
begin
  ...
  -- These flags drive durable handoffs and are also part of the incident record.
  -- Persist them in metadata for both the bound and no-binding branches.
  ...
  if p_binding_id is not null then
    -- Nested function calls share this transaction. Any later handoff failure
    -- rolls back the incident, workflow, events, audits, tasks and receipts.
