-- ============================================================================
-- Finance Payroll -- ATOMIC GL REVERSE v2 (execution-model alignment, 2 of 2)
-- ============================================================================
-- Supersedes the reverse_payroll_gl_tx created by 20260918000141 (which remains
-- the applied historical migration and is NOT edited). Companion to
-- 20260919000426 (post v2); shares its command-receipt table and idempotency
-- contract. MUST run after 20260919000420 and 20260919000426.
-- Service_role only. Idempotent / re-runnable.
-- ============================================================================
