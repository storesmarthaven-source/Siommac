-- ============================================================================
-- Messaging: post reactions (the deferred hidden-feature slice)
...
--   verify: select count(*)>0 from pg_proc where proname='messaging_toggle_reaction_tx';
-- ============================================================================
-- Rules (mirrors messaging_delete_message_tx conventions):
--   - Active participants only; system posts/threads and legal-hold threads and
--     deleted posts cannot be reacted to.
--   - Toggle semantics: same (post, user, emoji) removes; otherwise adds.
--   - Atomic: reaction row + thread version bump + outbox event + app_event in
--     one transaction. Custom SQLSTATEs are 5-char MG4xx.
-- ============================================================================
