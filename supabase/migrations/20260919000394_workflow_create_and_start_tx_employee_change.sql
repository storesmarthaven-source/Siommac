-- ============================================================================
-- Finding #3 Shape B (create-and-start) — shared RPC: hr_overtime_entries + hr_requests + hr_leave_requests + hr_org_change_requests + finance_pay_component_change_requests + hr_employee_change_requests
...
--   verify: select position('hr_employee_change_requests' in prosrc)>0
