...
from (values
  ...
  -- Worker 7 (employee) — FULL coverage, manual-handling renewing → overall DUE SOON
  ('b0000000-0000-4000-8000-000000000014'::uuid,'CERT-9014',7,'a1000000-0000-4000-8000-000000000001'::uuid,'a2000000-0000-4000-8000-000000000001'::uuid,'Working at Heights L1','SafeWork TT','WAH-0007', (now()-interval '180 day')::date, (now()+interval '520 day')::date,'current', true),
  ('b0000000-0000-4000-8000-000000000015'::uuid,'CERT-9015',7,'a1000000-0000-4000-8000-000000000002'::uuid,'a2000000-0000-4000-8000-000000000002'::uuid,'Confined Space Entry & Rescue','SafeWork TT','CSE-0007', (now()-interval '120 day')::date, (now()+interval '240 day')::date,'current', true),
  ('b0000000-0000-4000-8000-000000000016'::uuid,'CERT-9016',7,'a1000000-0000-4000-8000-000000000005'::uuid,'a2000000-0000-4000-8000-000000000005'::uuid,'Manual Handling (internal)',null,'MH-0007', (now()-interval '400 day')::date, (now()+interval '45 day')::date,'due_soon', true),
  -- Worker 8 (employee) — FULL coverage, manual-handling awaiting verification → overall PENDING
  ('b0000000-0000-4000-8000-000000000017'::uuid,'CERT-9017',8,'a1000000-0000-4000-8000-000000000001'::uuid,'a2000000-0000-4000-8000-000000000001'::uuid,'Working at Heights L1','SafeWork TT','WAH-0008', (now()-interval '160 day')::date, (now()+interval '540 day')::date,'current', true),
  ('b0000000-0000-4000-8000-000000000018'::uuid,'CERT-9018',8,'a1000000-0000-4000-8000-000000000002'::uuid,'a2000000-0000-4000-8000-000000000002'::uuid,'Confined Space Entry & Rescue','SafeWork TT','CSE-0008', (now()-interval '110 day')::date, (now()+interval '250 day')::date,'current', true),
  ('b0000000-0000-4000-8000-000000000019'::uuid,'CERT-9019',8,'a1000000-0000-4000-8000-000000000005'::uuid,'a2000000-0000-4000-8000-000000000005'::uuid,'Manual Handling (internal)',null,'MH-0008', (now()-interval '6 day')::date, (now()+interval '720 day')::date,'pending_verification', false),
  -- Worker 5 (manager) — first-aid current + fire-warden renewing → overall DUE SOON
  ('b0000000-0000-4000-8000-000000000020'::uuid,'CERT-9020',5,'a1000000-0000-4000-8000-000000000003'::uuid,'a2000000-0000-4000-8000-000000000003'::uuid,'Standard First Aid + CPR/AED','Red Cross','FA-0005', (now()-interval '140 day')::date, (now()+interval '820 day')::date,'current', true),
  ('b0000000-0000-4000-8000-000000000021'::uuid,'CERT-9021',5,'a1000000-0000-4000-8000-000000000004'::uuid,'a2000000-0000-4000-8000-000000000004'::uuid,'Fire Warden Training','SafeWork TT','FW-0005', (now()-interval '60 day')::date, (now()+interval '48 day')::date,'due_soon', true)
