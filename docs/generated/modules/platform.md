...
| `register-search` | Register search | registry | `() => <FormField label="Search employees"><SearchField value="Sarah" onInput={noop} /></FormField>` | `src/ui/registry/forms.defs.tsx:506` |
