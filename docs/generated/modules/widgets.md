...
| `hr.employeeMaster.activeWorkforce` | Active Workforce | registry | `ActiveWorkforce` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:458` |
| `hr.employeeMaster.departures` | Departures | registry | `Departures` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:463` |
| `hr.employeeMaster.employeeAttentionNeutral` | Employee Attention — Neutral | registry | `EmployeeAttentionNeutralWidget` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:465` |
| `hr.employeeMaster.exceptions` | Exceptions | registry | `Exceptions` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:461` |
| `hr.employeeMaster.hrWorkQueue` | HR Work Queue | registry | `HrWorkQueue` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:460` |
| `hr.employeeMaster.internalMovesCard` | Internal Moves | registry | `InternalMovesCard` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:467` |
| `hr.employeeMaster.lifecycleOutcomes` | Lifecycle Outcomes | registry | `LifecycleOutcomeChart` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:470` |
| `hr.employeeMaster.monthlyHiresCard` | Hires This Month | registry | `MonthlyHiresCard` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:466` |
| `hr.employeeMaster.newStarters` | New Starters | registry | `NewStarters` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:462` |
| `hr.employeeMaster.promotionsCard` | Promotions | registry | `PromotionsCard` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:468` |
| `hr.employeeMaster.readinessRadar` | Employee Readiness Radar | registry | `ReadinessRadar` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:469` |
| `hr.employeeMaster.recordQuality` | Record Quality | registry | `RecordQuality` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:464` |
| `hr.employeeMaster.recordReadiness` | Record Readiness | registry | `RecordReadiness` | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:459` |
...
| `widgets` | array / ui-tile | `src/ui/widgets/registry.hrEmployeeDashboard.tsx:457` | `-` |
...
| widget-registry | `src/ui/widgets/registry.hrEmployeeDashboard.tsx` | 479 |
