...
| frontend-page | `src/components/sections/Finance/FinanceSection.tsx` | 111 |
...
| frontend-page | `src/components/sections/Finance/PayRunDetailPage.tsx` | 405 |
...
| frontend-page | `src/components/sections/Finance/module.ts` | 166 |
